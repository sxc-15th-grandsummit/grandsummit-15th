...
const BENEFITS = [
  {
    ...
    description: 'Tackle a genuine business case from a leading industry collaborator, simulating the challenges faced by professionals in the field.',
  },
  {
    label: 'Industry Insights',
    description: 'Receive direct exposure to industry knowledge through coaching sessions led by seasoned professionals.',
  },
  {
    label: 'Personalized Mentoring',
    description: "Finalists enjoy exclusive 1-on-1 mentoring sessions with expert mentors, receiving actionable feedback tailored to their team's needs.",
  },
  {
    label: 'Professional Network Expansion',
    description: 'Connect with like-minded peers, industry professionals, mentors, and corporate leaders throughout the competition journey.',
  },
  {
    label: 'Skill Development',
    description: 'Sharpen critical thinking, strategic analysis, problem-solving, teamwork, and public speaking skills through progressive competition stages.',
  },
  {
    label: 'Prestigious Recognition',
    description: 'Compete at the national level, earn certificates, and stand a chance to win attractive prizes.',
  },
  {
...
const HERO_DECORATIONS = [
  {
    ...
    priority: true, quality: 100, sizes: '100vw', unoptimized: true,
  },
  {
    src: '/bcc/Ellipse 30.png',
    width: 391, height: 398,
...
type DecorationList = ReadonlyArray<{
  src: string; width: number; height: number; className: string
  sizes?: string; priority?: boolean; quality?: number; unoptimized?: boolean
}>

function Decorations({ assets }: { assets: DecorationList }) {
  return (
  ...
  return (
    <div className="min-h-screen w-full overflow-x-hidden text-white" style={{ backgroundColor: '#011f33' }}>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative z-10 px-4 pb-24 pt-32 text-center sm:px-6 md:px-20 md:pt-40">
          <div className="mx-auto max-w-5xl">
            ...
            <motion.div {...fadeUp(0.28)} className="mt-9 flex flex-wrap items-center justify-center gap-4">
              ...
              <a
                href={guidebookUrl} target="_blank" rel="noopener noreferrer"
        ...
        {/* ── Prize ──────────────────────────────────────────────── */}
        <div className="relative px-4 pb-20 pt-10 text-center sm:px-6 md:px-20">
      ...
      <section className="relative overflow-hidden px-4 py-12 sm:px-6 md:px-20">
        <Decorations assets={[
          { src: '/bcc/Ellipse 20.png', width: 378, height: 536, className: 'absolute -left-10 top-10 hidden w-16 opacity-14 md:block lg:left-0 lg:w-24', sizes: '(min-width: 1024px) 96px, 64px' },
          { src: '/bcc/Group 142.png', width: 226, height: 364, className: 'absolute right-2 bottom-6 hidden w-10 opacity-18 md:block lg:right-8 lg:w-14', sizes: '(min-width: 1024px) 56px, 40px' },
        ]} />
      ...
      <section className="relative overflow-hidden">
        ...
        {/* ── What will you get? ────────────────────────────────── */}
        <div className="relative px-4 pb-8 pt-12 text-center sm:px-6 md:px-20">
          <motion.h2
            {...revealUp()}
