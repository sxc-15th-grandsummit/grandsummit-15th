...
function CategoryCard({ label }: CategoryItem) {
  return (
    ...
    >
      <h3 className="font-plus-jakarta text-xl font-semibold tracking-[0.08em] text-white sm:text-2xl md:text-3xl">
        {label.toUpperCase()}
      </h3>
      <Link
        href="#registration"
  ...
  return (
    <section id="category" className="relative w-full py-10 md:h-[75vh] md:py-0">
      <SectionContainer className="flex flex-col justify-center md:h-full">
        ...
        <div className="mt-6 grid gap-4 md:mt-8 md:grid-cols-3 md:gap-20">
